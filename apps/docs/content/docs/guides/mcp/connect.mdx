...
<FAQ>
  <FAQItem
    ...
    answer="Any client that speaks the Model Context Protocol. Use the HTTP transport for remote clients like Claude Code, or the local stdio transport for clients like Claude Desktop. Both expose the same 49 tools."
  >
  ...
  >
    ...
    local command. Both expose the same 49 tools.
  </FAQItem>
</FAQ>
