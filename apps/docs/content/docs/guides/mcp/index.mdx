---
title: MCP & AI agents
description: RyTask ships a first-party MCP server with full parity — anything a person can do in the UI, an AI agent can do through a tool, under the same permissions.
---
