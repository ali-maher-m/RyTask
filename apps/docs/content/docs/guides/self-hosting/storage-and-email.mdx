---
title: Storage & email
description: MinIO and Mailhog sit in the stack for features still to come — neither is used yet, and invites work today via shareable links while email delivery is unwired.
---
