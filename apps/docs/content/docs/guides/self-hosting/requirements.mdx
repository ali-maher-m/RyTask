---
title: Requirements
description: Requirements for self-hosting RyTask — Docker and the Compose plugin for the recommended route, or Node 22, pnpm 9, Postgres, and Redis to run it from source.
---
