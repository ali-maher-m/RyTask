...
description: Back up RyTask with one command — a Postgres dump is the whole backup — then the exact steps to restore it and to test that your backups actually work.
---
