...
description: Run RyTask in production with Docker Compose — set the JWT secret the API won't boot without, add an override file, bring the stack up, and verify it's healthy.
---
