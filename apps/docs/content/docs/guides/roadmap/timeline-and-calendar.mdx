...
description: Timeline and calendar, planned for RyTask — Gantt-style timeline bars over dates and a calendar view, with an editable spreadsheet view and board swimlanes.
---
