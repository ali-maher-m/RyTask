---
title: Reporting
description: The "where did my time go?" report, the interruption ledger, and the My week summary — shipping in the next release.
---
...
Reporting ships in the next release — but the data it reads is **already being collected**.
Every timer you run and every entry you log today, with its planned-or-interruption
classification, becomes your history the moment the reports page arrives. Start tracking
now; the report will have something to say on day one.
