...
description: Slack capture troubleshooting — the real failure modes, from an unconnected workspace to rejected webhooks and a missing default project, with the fix for each.
---
