---
title: REST API
description: The RyTask REST API — base URL, bearer auth, keyset pagination, error codes, and idempotency, generated from the committed OpenAPI contracts and browsable by tag.
---
