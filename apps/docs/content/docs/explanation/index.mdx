---
title: Explanation
description: How RyTask is built and why — the modular-monolith architecture, multi-tenant isolation, time-tracking model, MCP parity, testing gates, and contributing.
---
